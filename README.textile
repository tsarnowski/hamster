...
Debian-based: @apt-get install git-core gettext intltool python-gconf python-requests python-beaker python-wnck python-dateutil@
RPM-based: @yum install git-core gettext intltool gnome-python2-gconf python-requests python-beaker python-wnck python-dateutil@
Other: 
